...
def update_graphs(n_intervals):
    ...
    current_mod_time = os.path.getmtime(r"C:\Users\fcp22sma\modelling_MCDM\CHP\CHP_plot_latest6.py")
...
# ======== CO2 Constraints ========
    ...
    def co2_emissions_rule(model, h):
        ...
        return model.co2_emissions[h] == (
            co2_per_unit_ng * model.fuel_blend_ng[interval] * model.fuel_consumed[h] +
            co2_per_unit_h2 * model.fuel_blend_h2[interval] * model.fuel_consumed[h] +
            co2_per_unit_bm * model.fuel_blend_biomass[interval] * model.fuel_consumed[h] +
